...
function LoginPage() {
  ...
  const handleGuestClick = async (e: React.MouseEvent) => {
    e.preventDefault();
    setError(null);
    setIsLoading(true);
    try {
  ...
  return (
    <div className="login-page container">
      <div className="title-wrapper">
        ...
        <h2 className="tagline form-group">
          Connect with friends and enemeis!
        </h2>
      </div>
      <form onSubmit={handleSubmit} className="form">
        <h2 className="form-group form__subtitle">
          Enter
          <br />
          The Lands Between!
        </h2>
